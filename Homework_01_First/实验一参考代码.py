...
print(
    "(1) Training data is a sine function with uniformly distributed noise from -0.5 to 0.5, and the code for generating training data is as follows:")
...
print(
    "(3) Draw the regression curve and the scatter plot of the training data. Compare the regression curve and scatter plot.")
y_hat = []
for x in x_train:
